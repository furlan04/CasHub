...
public class CurrenciesRemoteDataSource extends BaseCurrenciesDataSource {

    private final ForexAPIService forexAPIService;

    public CurrenciesRemoteDataSource(ForexAPIService forexAPIService) {
        ...
        forexAPIService.getCurrencies().enqueue(new Callback<Map<String, String>>() {
            ...
            public void onResponse(@NonNull Call<Map<String, String>> call, @NonNull Response<Map<String, String>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    callback.onCurrenciesFailureFromRemote(new Exception("Remote: Network error or empty response"));
                }
            }
